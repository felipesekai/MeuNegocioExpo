...
const Product = () => {
    ...
    const lista = [
        { key: '1', name: 'caja', price: 10, quantity: 500 },
        { key: '2', name: 'caju', price: 9, quantity: 500 },
        { key: '3', name: 'manga', price: 8, quantity: 500 },
        { key: '4', name: 'goiaba', price: 8, quantity: 500 },
        { key: '5', name: 'conserto de televissao smart', price: 8, quantity: 500 },
        { key: '6', name: 'montagem de guarda roupas grande com 6 portas ou 2 a 3 portas de correr', price: 8, quantity: 500 },
    ]
    return (
